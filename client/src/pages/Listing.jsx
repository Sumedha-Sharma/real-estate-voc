...
export default function Listing() {
  ...
  return (
    <main>
        {loading && (<p className='text-center my-20 font-semibold text-teal-600 text-3xl'> Loading....</p>)}
        {error && (<p className='text-center my-7 bg-red-400 text-3xl p-4 text-white rounded-lg  capitalize'>Something Went Wrong</p>)}
        ...
        { currentUser && listing.userRef!==currentUser._id && !contact &&(
             <button onClick={()=>setContact(true)} className=' rounded-lg bg-teal-700 p-3 uppercase :hover opacity-90 text-white '>Contact Landlord</button>
        ) }
